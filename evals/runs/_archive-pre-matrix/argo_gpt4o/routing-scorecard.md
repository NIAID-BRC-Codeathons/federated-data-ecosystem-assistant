...
|---|---|---|---|---|---|
| Q2 | How many E. coli isolates has NCBI sequenced? | `ncbi_pathogen_isolate_count` | 1 | 21.9s | ## Abstract The query to resolve how many *Escherichia coli* isolates have been sequenced  |
| Q3 | Are there any E. coli expression studies about ciprofloxacin? | `geo_search` | 1 | 28.7s | ## Abstract A search for Escherichia coli expression studies related to ciprofloxacin on G |
